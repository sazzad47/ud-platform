...
function changeHTMLAttribute(attribute, value) {
    if (document.documentElement) {
        // console.log(
        //     'in changeHTMLAttribute - document.documentElement: ',
...
function* changeLayoutMode({ payload: mode }) {
    try {
        console.log('I am in layouts > saga.js > changeLayoutMode');
        console.log(
            'we are calling yield call(changeHTMLAttribute, "data-layout-mode", mode);'
        );
        console.log({ mode });
