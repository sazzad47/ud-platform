...
import ObjectDetection from '../pages/Projects/ProjectView/ObjectDetectionPage';
...
const authProtectedRoutes = [
    ...
    { path: '/apps-project-view', component: ProjectView },
    ...
    // eslint-disable-next-line react/display-name
    {
        path: '/',
        exact: true,
        component: () => <Redirect to='/apps-projects-list' />,
    },
];
