...
const ObjectDetection = () => {
    document.title =
        'Object Detection | Velzon - React Admin & Dashboard Template';
                            ...
                            <PerfectScrollbar className='chat-room-list'>
                                ...
                                <div>
                                    <div className='px-3  rounded-2 mb-2'>
                                        <div className='d-flex align-items-center'>
                                            <div className='flex-grow-1'>
                                                <h6 className='mb-0 text-muted font-weight-normal'>
                                                    Instances
                                                </h6>
                                            </div>
                                            <div className='flex-shrink-0'>
                                ...
                                <div className='chat-message-list'>
                                    ...
                                    >
                                        <li>
                                            ...
                                            >
                                                <div className='d-flex align-items-center'>
                                                    <div className='flex-shrink-0 chat-user-img online align-self-center me-2 ms-0'></div>
                                                    <div className='flex-grow-1 overflow-hidden'>
                                                ...
                                                >
                                                    <div className='d-flex align-items-center'>
                                                        <div className='flex-shrink-0 chat-user-img online align-self-center me-2 ms-0'>
                                                            <div className='avatar-xxs'>
                                                                <div
                                                                    className={`avatar-title bg-gradient   rounded-circle text-body bg-${obj.color}`}
                                                                ></div>
                                                            </div>
                                                        </div>
                                                        <div className='flex-grow-1 overflow-hidden'>
                                                    ...
                                                    <CardBody>
                                                        <div className='live-preview'>
                                                            ...
                                                            <div className='ratio ratio-16x9'>
                                                                ...
                                                                <img
                                                                    src='https://media.wired.com/photos/5a31bcff41e00716c855d00e/16:9/w_2400,h_1350,c_limit/traffic-FA.jpg'
                                                            ...
                                                            <div className='py-2 mt-3   d-flex justify-content-between  align-items-center '>
                                                                <div className='d-flex align-items-center'>
                                                                    ...
                                                                    <Link to='#'>
                                                                        <i className='bx bx-skip-previous-circle bx-sm px-2'></i>
                                                                    </Link>
                                                                    <Link to='#'>
                                                                        <i
                                                                            className={`bx bx-${
                                                                    ...
                                                                    <Link to='#'>
                                                                        <i className='bx bx-skip-next-circle bx-sm px-2'></i>
                                                                    </Link>
                                                                </div>
                                                                <div className='d-flex align-items-center'>
                                                                    <div className='input-light '>
                                                                    ...
                                                                    <Link to='#'>
                                                                        <i className='bx bxs-cog bx-sm px-2'></i>
                                                                    </Link>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <Row className='py-2'>
                                        <Col xl={4} sm={4} md={4}>
                                            <img
                                                ...
                                                className=' avatar-md border border-1 border-primary rounded cursor-pointer'
                                            />
                                        </Col>
                                        <Col xl={4} sm={4} md={4}>
                                            <img
                                                ...
                                                className=' avatar-md border-sucess border border-1 border-secondary rounded cursor-pointer'
                                            />
                                        </Col>
                                        <Col xl={4} sm={4} md={4}>
                                            <img
                                                ...
                                                className=' avatar-md border border-1 border-success rounded cursor-pointer'
                                            />
                                        </Col>
                                    </Row>
                                    <Row className='py-2'>
                                        <Col xl={4} sm={4} md={4}>
                                            <img
                                                ...
                                                className=' avatar-md border border-1 border-warning rounded cursor-pointer'
                                            />
                                        </Col>
                                        <Col xl={4} sm={4} md={4}>
                                            <img
                                                ...
                                                className=' avatar-md border-sucess border border-1 border-danger rounded cursor-pointer'
                                            />
                                        </Col>
                                        <Col xl={4} sm={4} md={4}>
                                            <img
                                                ...
                                                className=' avatar-md border border-1 border-dark rounded cursor-pointer'
                                            />
                                        </Col>
                                    </Row>
                                    <Row className='py-2'>
                            ...
                            >
                                ...
                                <div className='modal-body text-center'>
                                    <img
                                        src={avatar4}
                                        alt=''
                                        className='avatar-xxl border-sucess border border-1 border-secondary rounded cursor-pointer'
                                    />
                                </div>
                            </Modal>
                        </div>
