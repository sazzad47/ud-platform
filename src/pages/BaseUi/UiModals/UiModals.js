...
import authbg from '../../../assets/images/blue-mesh-current.jpg';
// import authbg from '../../../assets/images/hexagon-windows.jpg';
// import authbg from '../../../assets/images/connected-cubes.jpg';
        ...
        <React.Fragment>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>modal-dialog-centered</code>{' '}
                                        class to show vertically center the
                                        modal.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>modal-fullscreen</code>,{' '}
                                        <code>modal-xl</code>,{' '}
                                        <code>modal-lg</code>, or{' '}
                                        <code>modal-sm</code> class to
                                        modal-dialog class to set different size
                                        modal respectively.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted text-muted'>
                                        Below mentioned modifier classes are
                                        used to show fullscreen modal as per
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Use <code>fadeInRight</code>,{' '}
                                        <code>fadeInLeft</code>,{' '}
                                        <code>fadeInUp</code>, <code>flip</code>
                                        , or <code>zoomIn</code> class to modal
                                        class to set different modal with
                                        animation effect respectively.
                                    </p>
                                    <div className='live-preview'>
                                        <div>
                                            <div className='hstack gap-2 flex-wrap'>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted text-muted'>
                                        ...
                                        <code>modal-dialog-bottom-right</code>{' '}
                                        class to modal-dialog class to set modal
                                ...
                                <Col xl={4} md={6}>
                                    <Card className='text-center border'>
                                        <CardBody className='p-4 pb-0'>
                                            ...
                                            <p className='text-muted'>
                                                Here is an example of a sweet
                                                alert with a success message.
                                            </p>
                                            <div>
                                                <Button
                                                    color='primary'
            ...
            >
                ...
                <div className='modal-body'>
                    ...
                    <p className='text-muted'>
                        It wasn't a dream. His room, a proper human room
                        although a little too small, lay peacefully between its
                        four familiar walls.
                    </p>
                </div>
            ...
            <Modal
                ...
                centered
            >
                <ModalHeader>Center Modal</ModalHeader>
                <div className='modal-body text-center p-5'>
                    ...
                    <div className='mt-4'>
                        ...
                        <p className='text-muted mb-4'>
                            {' '}
                            The transfer was not successfully received by us.
                            the email of the recipient wasn't correct.
                        </p>
                ...
                <div className='modal-body text-center p-5'>
                    ...
                    <div className='mt-4 pt-3'>
                        ...
                        <p className='text-muted mb-4'>
                            ...
                            below Automatically Send your invitees a follow -Up
                            email.
                        </p>
                        <div className='hstack gap-2 justify-content-center'>
                            <Button
            ...
            >
                ...
                <div className='modal-body'>
                    ...
                    <p className='text-muted'>
                        ...
                        <Link
                            to='#'
                            className='popover-test fw-medium text-decoration-underline link-success'
                            id='UncontrolledPopover'
                        >
                            Popover on Click
                        </Link>{' '}
                        you do every day. So let's get started. First, some
                        common types of fonts and what you need to know about
                        them triggers a popover on click.
                    </p>
                    <UncontrolledPopover
                        placement='bottom'
                ...
                <div className='modal-footer'>
                    <div className='mx-auto'>
                        <Link to='#' className='btn btn-link fw-medium'>
                            Read More{' '}
            ...
            >
                ...
                <div className='modal-body'>
                    ...
                    <div className='d-flex mt-2'>
                        ...
                        <div className='flex-grow-1 ms-2 '>
                            <p className='text-muted mb-0'>
                                ...
                                example below, can make things unpleasant for
                                the reader. The goal is to make your text as
                    ...
                    <div className='d-flex mt-2'>
                        ...
                        <div className='flex-grow-1 ms-2 '>
                            <p className='text-muted mb-0'>
                                In some designs, you might adjust your tracking
                                to create a certain artistic effect. It can also
                                help you fix fonts that are poorly spaced to
                                begin with.
                            </p>
                        </div>
                    </div>
                    <div className='d-flex mt-2'>
                        ...
                        <div className='flex-grow-1 ms-2 '>
                            <p className='text-muted mb-0'>
                                ...
                                spoke to many different professional graphic
                                designers and asked them what graphic design
                                tips they live.
                            </p>
                        </div>
                    </div>
                    <div className='d-flex mt-2'>
                        ...
                        <div className='flex-grow-1 ms-2 '>
                            <p className='text-muted mb-0'>
                                ...
                                The same is true for fonts. Don't be afraid to
                                combine font styles that are different but
                                complementary, like sans serif with serif, short
                    ...
                    <div className='d-flex mt-2'>
                        ...
                        <div className='flex-grow-1 ms-2 '>
                            <p className='text-muted mb-0'>
                                Opposites attract, and that’s a fact. It’s in
                                our nature to be interested in the unusual, and
                                that’s why using contrasting colors in Graphic
                                Design is a must. It’s eye-catching, it makes a
                                statement, it’s impressive graphic design.
                    ...
                    <div className='d-flex mt-2'>
                        ...
                        <div className='flex-grow-1 ms-2 '>
                            <p className='text-muted mb-0'>
                                Just like in the image where we talked about
                                using multiple fonts, you can see that the
                                background in this graphic design is blurred.
                                Whenever you put text on top of an image, it’s
                    ...
                    <div className='d-flex mt-2'>
                        ...
                        <div className='flex-grow-1 ms-2 '>
                            <p className='text-muted mb-0'>
                                Keytar raw denim keffiyeh etsy art party before
                                they sold out master cleanse gluten-free squid
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='hstack gap-2 justify-content-center'>
                            <Link
                                to='#'
                                className='btn btn-link link-success fw-medium'
                                onClick={() => setmodal_positionBottom(false)}
                            >
                                <i className='ri-close-line me-1 align-middle'></i>{' '}
                                Close
                            </Link>
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='hstack gap-2 justify-content-center'>
                            <Link
                                ...
                                className='btn btn-link link-success fw-medium'
                                onClick={() =>
                                    setmodal_positionBottomRight(false)
                                }
                            >
                                <i className='ri-close-line me-1 align-middle'></i>{' '}
                                Close
                ...
                <ModalBody className='text-center p-5'>
                    ...
                    <div className='mt-2'>
                        ...
                        <p className='text-muted fs-15 mb-4'>
                            Successful transaction is the status of operation
                            whose result is the payment of the amount paid by
                            the customer in favor of the merchant.
                        </p>
                        <div className='hstack gap-2 justify-content-center'>
                            ...
                            <button className='btn btn-soft-success'>
                                <i className='ri-links-line align-bottom'></i>{' '}
                                Copy tracking link
                            </button>
                        </div>
                    </div>
                    ...
                    <ModalBody className='login-modal p-5'>
                        ...
                        <div className='vstack gap-2 justify-content-center'>
                            <button className='btn btn-light'>
                                <i className='ri-google-fill align-bottom text-danger'></i>{' '}
                                Google
                            </button>
                            <button className='btn btn-info'>
                                <i className='ri-facebook-fill align-bottom'></i>{' '}
                                Facebook
                            </button>
                        </div>
                    </ModalBody>
                    ...
                    <Col lg={7}>
                        <div className='modal-body p-5'>
                            <h2 className='lh-base'>
                                Subscribe now today to get{' '}
                                <span className='text-danger'>20% off</span>{' '}
                                experiences!
                            </h2>
                            <p className='text-muted mb-4'>
                                A free bet is a bet which is provided by a
                                betting site for a customer to place and then
                                benefit from the winnings. Free bets are
                                commonly used as welcome offers.
                            </p>
                            ...
                            <div className='form-check'>
                                ...
                                >
                                    By subscribing to a particular channel or
                                    user on YouTube, you can receive instant
                                    updates.
                                </label>
                            </div>
                        </div>
                    ...
                    <Col lg={5}>
                        <div className='subscribe-modals-cover h-100'>
                            <img
                                ...
                                style={{
                                    clipPath:
                                        'polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%)',
                                }}
                            />
                        </div>
                    </Col>
            ...
            >
                ...
                <Alert color='success' className='rounded-0 mb-0'>
                    <p className='mb-0'>
                        Up to <span className='fw-semibold'>50% OFF</span>,
                        Hurry up before the stock ends
                    </p>
                </Alert>
                <ModalBody>
                    <form>
