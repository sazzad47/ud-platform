...
const FormValidations = () => {
    ...
    document.title =
        'Form Validation | Velzon - React Admin & Dashboard Template';
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        Not interested in custom validation
                                        feedback messages or writing JavaScript
                                        to change form behaviors? All good, you
                                        can use the browser defaults. Try
                                        submitting the form below. Depending on
                                        your browser and OS, you’ll see a
                                        slightly different style of
                                        feedback.While these feedback styles
                                        cannot be styled with CSS, you can still
                                        customize the feedback text through
                                        JavaScript.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>
                                        ...
                                        messages, you’ll need to add the{' '}
                                        <code>novalidate</code> boolean
                                        attribute to your{' '}
                                        <code>&lt;form&gt;</code>. This disables
                                        the browser default feedback tooltips,
                                        but still provides access to the form
                                        validation APIs in JavaScript. Try to
                                        submit the form below; our JavaScript
                                        will intercept the submit button and
                                        relay feedback to you. When attempting
                                        to submit, you’ll see the{' '}
                                        <code>:invalid</code> and{' '}
                                        <code>:valid</code> styles applied to
                                        your form controls.
                                    </p>
                                    <div className='live-preview'>
                                        <Form
